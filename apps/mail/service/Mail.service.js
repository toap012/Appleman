...
function _createMails() {
    ...
    if (!mails || !mails.length) {
        ...
        mails.push(_createMail('Remeber me?', true, 'dsa@appleman.com'))
        mails.push(_createMail('names', true, 'agag@appleman.com'))
        mails.push(_createMail('SO...', false, 'asav@appleman.com'))
        mails.push(_createMail('GUESS what', false, 'assdasda@appleman.com'))
        mails.push(_createMail('ICE CREAM!', true, 'agag@appleman.com'))
        mails.push(_createMail('EASY PAYMENT', false, 'agag@appleman.com'))
        mails.push(_createMail('Why is everything caps', true, 'atat@appleman.com'))
        mails.push(_createMail('STop asking questions', true, 'sss@appleman.com'))
        mails.push(_createMail('Coding academy', true, 'agaag@appleman.com'))
        mails.push(_createMail('Best subject ever', false, 'sadasda@appleman.com'))
        mails.push(_createMail('maybe next time', false, 'mwe@appleman.com'))
        mails.push(_createMail('Linkdin', true, 'secret@appleman.com'))
